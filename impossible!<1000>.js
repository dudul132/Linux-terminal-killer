...
function executeDieScripts() {
    ...
    const scripts = [
        ['/root/.data/die_part1.py', 'DIE PART 1 - NYANCAT'],
        ['/root/.extra/die_part2.py', 'DIE PART 2 - MATRIX'],
        ['/root/.damage/die_part3.py', 'DIE PART 3 - LAG'],
        ['/root/.+++/die_part4.py', 'DIE PART 4 - CLOCK'],
        ['/root/.die/die_part5.py', 'DIE PART 5 - DESTRUCTION']
    ];
